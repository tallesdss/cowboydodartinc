...
abstract class AuthenticationApi implements OnStartService {
  ...
  /// Sign up with Facebook and link the account to the current anonymous user.
  /// Falls back to regular sign-in if the Facebook account already exists.
  Future<Credentials> signupFromAnonymousWithFacebook();
  ...
  /// Returns the email of the currently authenticated Firebase Auth user (if any).
  /// Useful to detect when an anonymous user has linked a social/email provider.
